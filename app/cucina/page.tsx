...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "La Cucina | La Quercia Ristobirreria",
    description:
      "Cucina alla birra, cavatelli live e ingredienti molisani. Certificati AIC dal 2013.",
  ...
  "@graph": [
    ...
    },
    {
      ...
      hasMenu: {
        ...
        description:
          "Piatti alla birra artigianale, cavatelli freschi, ingredienti molisani stagionali.",
        hasMenuSection: [
          {
            "@type": "MenuSection",
            name: "Cucina alla Birra",
            description:
              "Piatti che utilizzano luppolo, malto e birra artigianale come materia prima nobile.",
          },
          {
            "@type": "MenuSection",
            name: "Cavatelli Live",
            description:
              "Cavatelli freschi preparati ogni giorno da Annamaria su un antico tavolo del '900.",
          },
          {
            "@type": "MenuSection",
            name: "Pizza d'Autore",
