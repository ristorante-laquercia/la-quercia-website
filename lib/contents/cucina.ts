		...
		techniques: [
			{
				title: "Il Luppolo",
				description:
					"Foglie, polvere e fiori coltivati da noi per portare nei piatti note erbacee, amare o floreali.",
			},
			{
				title: "Il Malto",
				description:
					"Tostato e triturato al mortaio per dare profondita a dolci, carni e legature aromatiche.",
			},
			{
				title: "Le Marinature",
				description:
					"Dalla Pils alla Blanche, ogni stile viene scelto per rendere le carni piu tenere, vive e aromatiche.",
			},
			{
