		...
		cards: [
			{
				...
				title: "L'Aperibirra",
				description:
					"Dimentica il solito tagliere: per il tuo aperitivo meriti molto di piu.",
				details:
			...
			},
			{
				...
				description:
					"Abbiamo pensato anche ai piu piccoli, senza rinunciare alla qualita del momento.",
				details:
			...
			},
			{
				...
				title: "Drink & Play",
				description:
					"Il dopocena perfetto e fatto di ottime birre, sfide leggere e tempo condiviso.",
				details:
