export const birreriaContent = {
  ...
  selezione: {
    ...
    vieText:
      'Dedicate stabilmente a due pilastri della storia birraria: il birrificio ceco <strong>Ferdinand</strong> e il mito bavarese <strong>Augustiner</strong>. Quattro spine che rappresentano la perfezione stilistica e la costanza qualitativa.',
    quintaLabel: 'La 5ª Via',
    quintaText:
      'È il nostro spazio dedicato alla scoperta. Qui facciamo ruotare proposte che variano con la <strong>stagionalità</strong>, offrendo stili diversi e alternative ricercate per incuriosire anche i palati più esigenti.',
    sommelier: {
