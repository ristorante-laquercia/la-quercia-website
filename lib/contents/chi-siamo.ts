export const chiSiamoContent = {
  radici: {
    ...
    descriptionFirstBlock:
      ...
      descriptionSecondBlock: "È qui che nasce la nostra ossessione per la genuinità e per l'accoglienza, valori che ancora oggi sono le fondamenta del locale.",
  },
  present: {
    title:"Il Presente: L'Innovazione",
    description: "<p>La tradizione, per restare viva, deve evolversi. Dal 2014, con la vittoria di Pulcherio al campionato mondiale di spillatura Pilsner Urquell e il percorso da Beer Sommelier, La Quercia cambia pelle.</p><p>La birra diventa protagonista assoluta, trasformando il locale in un laboratorio di gusto e cultura. Non abbiamo dimenticato chi siamo: Annamaria è ancora lì, a impastare cavatelli in sala, ma accanto a lei oggi c’è una cucina che sperimenta con luppoli e malti.</p>"
  },
  filosofia: {
    title: "Siamo Ristobirreria, siamo famiglia, siamo esperienza.",
    description: "<p>La ristorazione per noi significa esperienza e spontaneità, soprattutto oggi.</p><p>Vogliamo essere il tuo luogo di ritrovo preferito. Un porto sicuro dove staccare la spina, lavorare in tranquillità, giocare con gli amici o scoprire che il luppolo può essere un ingrediente di un nuovo piatto.</p>"
  }
} as const;
