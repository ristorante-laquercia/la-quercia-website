	...
	return (
		...
		>
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle, oklch(0.8559 0.1143 85.04 / 0.07) 0%, transparent 70%)",
				}}
			/>
			...
			<Container className="relative z-10">
				<div className="grid grid-cols-1 gap-y-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-x-14">
					...
					>
						...
						<div
							aria-hidden
							className="absolute bottom-8 left-7 flex flex-col items-center gap-3"
						>
					...
					>
						...
						<RevealItem preset="fade-up" distance={24} duration={1.05}>
							<h2
								id={titleId}
								className="max-w-3xl font-gabarito text-white"
						...
						>
							{cucinaContent.innovation.techniques.map((item) => (
								...
								>
									...
									<h3 className="font-gabarito text-xl font-black tracking-tight text-lq-senape">
										{item.title}
									</h3>
