        ...
        >
          <div className="flex flex-col gap-y-6">
            ...
            <RevealItem preset="fade-up" distance={24} duration={1.05}>
              <h2
                id={titleId}
                className="max-w-3xl font-gabarito text-lq-dark"
            ...
            <RevealItem preset="fade-up" distance={28} duration={1.25}>
              <blockquote className="mt-4 border-l-[3px] border-lq-orange/50 pl-5">
                <p
                  className="font-gabarito text-xl font-light italic text-lq-dark/55"
                  style={{ letterSpacing: "0.01em" }}
                >
                  &rdquo;Non usiamo la birra come nota aromatica — la trattiamo
                  come una materia prima nobile.&rdquo;
                </p>
              </blockquote>
            </RevealItem>
          </div>
