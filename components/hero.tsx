...
export function Hero() {
  ...
  return (
    <section className="relative isolate h-dvh min-h-136 w-full overflow-hidden bg-lq-dark">
      ...
      >
        <title>Overlay scuro con testo trasparente</title>
        <defs>
          <linearGradient id="hero-dark-gradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#2a2926" stopOpacity="1" />
            <stop offset="50%" stopColor="#34322f" stopOpacity="1" />
            <stop offset="100%" stopColor="#1f1e1b" stopOpacity="1" />
          </linearGradient>
