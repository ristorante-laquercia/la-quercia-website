...
export function BookNowBanner() {
  return (
    <section className="w-full bg-linear-to-br from-lq-senape via-lq-senape to-lq-yellow py-24">
      <Container className="grid grid-cols-1 gap-8 px-8 lg:grid-cols-2 lg:items-center">
        <div className="space-y-4">
          <h2>Prenota il tuo tavolo</h2>
          <p>
            Organizza la tua prossima serata alla Quercia: cucina, birre e
            atmosfera nel momento giusto.
          </p>
        </div>
