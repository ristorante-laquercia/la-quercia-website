...
export function EventsSection() {
  ...
  return (
    ...
    >
      <Container>
        <Image src={demoImage.src} alt="" className="absolute left-0 top-0 z-0 size-full object-cover" fill />
        <div aria-hidden className="pointer-events-none absolute inset-0 z-10 bg-black/35" />
        <div
          aria-hidden
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <RevealItem className="relative aspect-4/5 overflow-hidden rounded-lg" duration={1.2}>
              <Image src={demoImage1} alt="Foto evento 1" fill className="object-cover" />
            </RevealItem>
            <RevealItem className="relative aspect-4/5 overflow-hidden rounded-lg" duration={1.35}>
              <Image src={demoImage2} alt="Foto evento 2" fill className="object-cover" />
            </RevealItem>
            <RevealItem className="relative aspect-4/5 overflow-hidden rounded-lg" duration={1.5}>
              <Image src={demoImage3} alt="Foto evento 3" fill className="object-cover" />
            </RevealItem>
            <RevealItem className="relative aspect-4/5 overflow-hidden rounded-lg" duration={1.65}>
              <Image src={demoImage4} alt="Foto evento 4" fill className="object-cover" />
            </RevealItem>
          </div>
        </RevealGroup>
      </Container>
