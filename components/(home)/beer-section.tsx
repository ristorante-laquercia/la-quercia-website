    ...
    >
      <div
        ...
        style={{
          ...
          maskImage: 'radial-gradient(130% 100% at 55% 42%, black 18%, rgba(0,0,0,0.82) 46%, transparent 78%)',
          WebkitMaskImage: 'radial-gradient(130% 100% at 55% 42%, black 18%, rgba(0,0,0,0.82) 46%, transparent 78%)',
        }}
      />
