...
export function AboutRootsBackground() {
  ...
  return (
    <div aria-hidden="true" role="presentation" className="pointer-events-none absolute inset-0 z-1 overflow-hidden">
      <motion.div
      ...
      >
        ...
        >
          <RootSvg decorative animateDraw className="h-auto w-[150%] max-w-none md:w-[125%] xl:w-[110%]" />
        </motion.div>
      </motion.div>
    </div>
  )
