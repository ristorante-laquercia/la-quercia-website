...
export function DiagonalElement({
  ...
  const pathByPositionAndSide: Record<`${'top' | 'bottom'}-${'left' | 'right'}`, string> = {
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none" className="size-full">
