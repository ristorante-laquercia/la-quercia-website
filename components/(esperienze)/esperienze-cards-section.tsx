      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <RevealItem preset="fade-left" distance={32} duration={1.1}>
            <div id={descriptionId} className="max-w-sm border-l-2 border-lq-orange/40 pl-5 lg:pb-2">
              <p className="text-base leading-relaxed text-white/85">{esperienzeContent.experiences.description}</p>
            </div>
          </RevealItem>
        </RevealGroup>
            ...
            >
              <article className="xl:contents">
                ...
                <div className="space-y-3 bg-white px-7 pt-4 pb-2">
                  ...
                  <p className="text-sm leading-relaxed text-lq-dark/75">{card.details}</p>
                </div>
